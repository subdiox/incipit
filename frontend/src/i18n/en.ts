...
export const en = {
  ...
  'recommend.subtitle': 'Personalized picks from your favorites and reading history',
  'recommend.empty': 'No recommendations yet. Favorite some books or read a few, and picks will appear here.',
  ...
  'book.read': 'Read',
  'book.readFromStart': 'Read from start',
