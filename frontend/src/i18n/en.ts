...
export const en = {
  ...
  'panes.tags': 'Tags',
  'panes.tagsHelp': 'Pick the tags this pane filters by.',
  'panes.noTags': 'No tags (all books)',
  'panes.matchMode': 'Match',
  'panes.matchAll': 'All tags',
  'panes.matchAny': 'Any tag',
  'panes.matchAllHelp': 'Books must have every selected tag (AND).',
  'panes.matchAnyHelp': 'Books need at least one of the selected tags (OR).',
  'panes.anyBadge': 'any:',
  'panes.or': 'or',
