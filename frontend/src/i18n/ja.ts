...
export const ja: Record<TranslationKey, string> = {
  ...
  'reader.flow': '読み方',
  'reader.flowPaged': 'ページめくり',
  'reader.flowScroll': 'スクロール',
  'reader.binding': '綴じ方向',
  ...
  'panes.tags': 'タグ',
  'panes.tagsHelp': 'このペインで絞り込むタグを選択してください。',
  'panes.noTags': 'タグなし(全書籍)',
  'panes.matchMode': '一致条件',
  'panes.matchAll': 'すべてのタグ',
  'panes.matchAny': 'いずれかのタグ',
  'panes.matchAllHelp': '選択したすべてのタグを持つ本のみ表示(AND)。',
  'panes.matchAnyHelp': '選択したタグのいずれかを持つ本を表示(OR)。',
  'panes.anyBadge': 'いずれか:',
  'panes.or': 'または',
