...
export const ja: Record<TranslationKey, string> = {
  ...
  'recommend.subtitle': 'お気に入りと読書履歴からのあなた向けの提案',
  'recommend.empty': 'まだおすすめを作成できません。本をお気に入りに追加するか、何冊か読むと、ここに提案が表示されます。',
  'history.all': '読み終わった本',
  ...
  'account.pageSizeHelp': '各ライブラリ画面に表示する件数です。',
  'account.theme': '外観',
  ...
  'library.sort.favorites': '人気順',
  'library.sort.views': '閲覧数順',
  'library.sort.lastread': '最近読まれた順',
  'library.filters': '絞り込み',
  'library.viewSeries': 'シリーズ',
  'library.viewVolumes': '巻',
  'library.volumeCount': '全{{count}}巻',
  'library.seriesLabel': 'シリーズ',
  'library.worksCount': '{{count}}作品',
  ...
  'book.fieldRating': '評価',
  'book.favorites': 'お気に入り',
  'book.fieldComments': 'コメント',
  'book.fieldCover': '表紙',
  'book.chooseCover': '画像を選択',
  'book.coverClear': '取り消し',
  'enrich.button': 'コミックシーモアで更新',
  // Multi-select + bulk actions
  'select.enter': '選択',
  'select.exit': '完了',
  'select.count': '{{count}}冊を選択中',
  'select.all': 'ページを全選択',
  'select.none': '選択解除',
  'select.compare': 'メタデータ比較',
  'select.edit': '編集',
  'select.delete': '削除',
  'select.selectOne': '選択',
  'select.deselectOne': '選択を外す',
  'bulk.editTitle': '{{count}}冊を編集',
  'bulk.editHint': 'チェックした項目だけが変更されます。選択したすべての本に同じ値が適用されます。',
  'bulk.tags.add': '追加',
  'bulk.tags.replace': '置換',
  'bulk.tags.remove': '削除',
  'bulk.tagsPlaceholder': 'カンマ区切りのタグ',
  'bulk.replace': '検索・置換',
  'bulk.find': '検索文字列',
  'bulk.replaceWith': '置換後',
  'bulk.replaceHint': '各タイトル内の一致部分を置換します（各本は個別のまま）。置換後を空にすると削除。フォルダ名も変わります。',
  'bulk.apply': '{{count}}冊に適用',
  'bulk.progress': '更新中… {{done}}/{{total}}',
  'bulk.failedSome': '{{count}}冊を更新できませんでした',
  'bulk.nothingEnabled': '変更する項目を1つ以上有効にしてください。',
  'bulk.deleteTitle': '{{count}}冊を削除',
  'bulk.deleteConfirm': '選択した{{count}}冊とそのファイルを完全に削除しますか？この操作は取り消せません。',
  'bulk.deleteConfirmBtn': '{{count}}冊を削除',
  'bulk.deleting': '削除中… {{done}}/{{total}}',
  'compare.title': 'メタデータの比較・適用',
  'compare.subtitle': '{{count}}冊 · 左が現在の内容、右がコミックシーモア',
  'compare.matched': '一致',
  'compare.noMatch': '該当なし',
  'compare.error': '失敗',
  'compare.matchedCount': '{{total}}冊中{{matched}}冊が一致',
  'compare.selectAll': 'すべて',
  'compare.selectNone': '解除',
  'compare.refetchAll': 'すべて再検索',
  'compare.apply': '{{count}}冊に適用',
  'compare.applying': '適用中… {{done}}/{{total}}',
  'compare.willApply': '{{count}}冊が更新されます',
  ...
  'shelves.volumeCount': '全{{count}}巻',
  'shelves.seriesCount': '{{count}}シリーズ',
  'shelves.emptyShort': '空',
  'shelves.makePrivate': '非公開にする',
  'shelves.sectionPrivate': '自分の非公開本棚',
  'shelves.sectionMyPublic': '自分の公開本棚',
  'shelves.sectionOthers': 'みんなの公開本棚',
  'shelves.byOwner': '{{name}} さん',
  'shelves.unavailableTitle': '本棚を表示できません',
  'shelves.unavailableHint': 'この本棚は非公開か、削除されています。',
  ...
  'addToShelf.favorite': 'お気に入りに追加',
  'addToShelf.unfavorite': 'お気に入りから外す',
  'addToShelf.added': '追加済み',
  'addToShelf.add': '追加',
  ...
  'settings.tabAuth': '認証',
  'settings.tabCollections': 'コレクション',
  'settings.tabUsers': 'ユーザー',

  // ライブラリコレクション(管理者定義の保存フィルタ)
  'collections.subtitle': 'ライブラリ下に表示される保存タグフィルタ。コレクションはタグに一致する本を一覧します。',
  'collections.new': '新規コレクション',
  'collections.reorder': 'ドラッグで並べ替え',
  'collections.newTitle': '新規コレクション',
  'collections.editTitle': 'コレクションを編集',
  'collections.empty': 'コレクションがありません。作成するとライブラリ下に絞り込みビューが追加されます。',
  'collections.name': '名前',
  'collections.namePlaceholder': '例: アクション',
  'collections.tags': 'タグ',
  'collections.tagsHelp': '含めるタグ。空にすると全書籍が対象です。',
  'collections.noTags': 'タグなし(全書籍)',
  'collections.excludeTags': '除外タグ',
  'collections.excludeTagsHelp': 'これらのタグを持つ本は除外(非表示)されます。',
  'collections.excludeBadge': '除外',
  'collections.matchMode': '一致条件',
  'collections.matchAll': 'すべてのタグ',
  ...
  'collections.deleteConfirm': 'コレクション「{{name}}」を削除しますか?本には影響しません。',
  'settings.save': '設定を保存',
  ...
  'server.homeFilterIncludeHelp': '設定すると、選択したタグをすべて持つ本だけをホームに表示します。空の場合はすべて表示。',
  'server.homeFilterExclude': 'これらのタグを非表示',
  'server.homeFilterExcludeHelp': 'これらのタグを持つ本は、ホームライブラリから非表示になります。',
